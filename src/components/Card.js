...
export const Card = ({content,username,createdAt,_id,firstName,lastName}) => {
    ...
    return(
        <div className="text-color flex  p-4 border-b-2" >
            ...
            <div clasName="flex justify-center">
             <div className="p-1 flex w-2/4 justify-center flex-col">
                <h3 className="inline-block">{firstName} {lastName}</h3>
                <p className="inline-block">@{username}</p>
                </div>
                <h3 className="p-1 inline-block w-2/4">{createdAt}</h3>
                </div>
